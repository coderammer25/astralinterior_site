  ...
  return (
    <section className="container mx-auto px-4 py-16 grid lg:grid-cols-2 gap-8 items-center min-h-[100vh]">
      ...
      <div className="relative md:-ml-[15px] lg:-ml-[120px] md:h-[600px] w-[456px] h-[500px] md:w-[760px] lg:w-[735px] lg:h-[600px] p-3">
        ...
        <div className="absolute bottom-16 right-0 h-56 w-56 md:h-60 md:w-60 lg:w-60 lg:h-60 z-50">
          <Image
            src={image3}
      ...
      <div className="lg:flex md:grid grid-cols-2 md:grid-cols-2 gap-8 md:gap-16 items-center">
        ...
        <div className="relative lg:w-[800px]">
          ...
          src={image4}
          alt="mini"
          className="absolute md:-mt-[310px] md:ml-[240px] lg:-mt-[430px] w-0 lg:ml-[340px] md:w-[130px] lg:w-[200px]"
          />
        </div>

        <div className="space-y-8 mt-5 lg:ml-[150px]">
          <div className="space-y-6">
            <h2 className="text-sm uppercase tracking-wider text-muted-foreground">WHO WE ARE</h2>

            <p className=" lg:text-[24px] leading-relaxed ">
              Our team of experienced designers <br /> collaborates closely with each client, <br /> ensuring that every project
              reflects <br /> their unique style and vision. From initial <br /> concept to final installation, we manage <br /> every aspect
              of the design journey,  bringing a seamless and enjoyable  experience.
            </p>
          </div>
