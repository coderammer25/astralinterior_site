...
const Item = ({ title, children, isOpen, onToggle, ...props }: ItemProps) => {
	return (
		<div className="border-b" {...props}>
			<button
				...
				onClick={onToggle}
			>
				<h4 className="text-left text-[1.2rem] xl:text-[1.4rem] uppercase w-3/4 md:w-full">
					{title}
				</h4>
			...
			<div className={`p-4 pt-0 transition-all duration-300 ${isOpen ? "block" : "hidden"}`}>
